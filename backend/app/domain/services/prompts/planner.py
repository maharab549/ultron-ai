...
5. Ensure the plan is robust and accounts for potential failures or edge cases
6. Prioritize steps that gather information first before taking action
7. For complex tasks, ensure the plan includes verification and testing phases
"""
