...
class OpenAILLM(LLM):
    ...
    async def ask(self, messages: List[Dict[str, str]],
        ...
        # LM Studio (and some other local model servers) only support
        # response_format types "json_schema" and "text".  The OpenAI-native
        # "json_object" type is not supported and causes a 400 error.
        # Convert it to the compatible "json_schema" equivalent.
